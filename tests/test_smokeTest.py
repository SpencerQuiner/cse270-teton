...
class TestSmokeTest():
  ...
  def test_adminTest(self):
    ...
    self.vars["username"] = self.driver.find_element(By.ID, "username").get_attribute("value")
    self.vars["password"] = self.driver.find_element(By.ID, "password").get_attribute("value")
  ...
  def test_homeTest(self):
    ...
    self.driver.set_window_size(1155, 1032)
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "legend").text == "Enter Credentials"
  ...
  def test_joinTest(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "legend").text == "Contact Information"
